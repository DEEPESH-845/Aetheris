    ...
    <section className="relative min-h-[100dvh] pt-32 pb-20 px-6 md:px-12 flex items-center overflow-hidden">
      ...
      <div className="w-full max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center relative z-10">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          >
            Aetheris ingests multimodal telemetry, correlates threat vectors using LangGraph, and physically alters network topologies via eBPF in milliseconds.
          </motion.p>
          ...
          >
            <Link href="/dashboard" className="w-full sm:w-auto">
              <CyberButton variant="primary" className="w-full sm:w-auto px-8 py-4 text-sm" icon={<ArrowRight className="w-4 h-4" />}>
                Initialize Sandbox
              </CyberButton>
            </Link>
